...
Mean number of steps per day: `r as.integer(mean.steps)`

Median number of steps per day: `r as.integer(median.steps)`
...
So this is the interval number `r as.integer(max.int[,1])`
...
Which is about `r as.integer((sum(is.na(activity)[,1])/dim(activity)[1])*100)` percent of the whole dataset.
...
Mean number of steps per day: `r as.integer(mean.steps.nona)`

Median number of steps per day: `r as.integer(median.steps.nona)`
